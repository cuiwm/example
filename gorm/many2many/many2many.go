...
func main() {
	//	//("mysql", "andrew:andrew123@tcp(192.168.32.135:3306)/qidian?charset=utf8&parseTime=True&loc=Local")
	db, _ := gorm.Open("mysql", "andrew:andrew123@tcp(192.168.32.135:3306)/qidian?charset=utf8&parseTime=True&loc=Local")
	// "root:root@tcp(127.0.0.1:3306)/testmapping?charset=utf8&parseTime=True")
	defer db.Close()
	db.LogMode(true)
